-- XERIS ADAPTATION OF VAPEV4 SOURCE
...
--XERIS
local Xeris = GuiLibrary.CreateWindow({
	["Name"] = "Xeris", 
	["Icon"] = "vape/assets/Xeris.png", 
	["IconSize"] = 25
})
...
GUI.CreateButton({
	["Name"] = "Xeris", 
	["Function"] = function(callback) Xeris.SetVisible(callback) end, 
	["Icon"] = "vape/assets/Xeris.png", 
	["IconSize"] = 24
})
GUI.CreateButton({
